...
(function (global, factory) {
  ...
  var isSupportAmd = "function" === 'function' && __webpack_require__(14); // eslint-disable-line
  /**
  ...
  */
  ...
  if (env.hasCodeMirror) {
      if (env.isSupportAmd) {
          new Promise(function(resolve) { resolve(); }).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(3)]; (function (cm) {
              CodeMirror = cm;
...
var ReactSummernote = function (_Component) {
  ...
  function ReactSummernote(props) {
    ...
    _this.insertCode = _this.insertCode.bind(_this);
    ...
    ReactSummernote.insertCode = _this.insertCode.bind(_this);
    return _this;
  }
  ...
  _createClass(ReactSummernote, [{
    ...
    key: 'insertCode',
    value: function insertCode(code) {
